...
export CATALINA_OPTS="$CATALINA_OPTS -DGEOSERVER_DATA_DIR=/var/opt/geoserver/data"
...
export JAVA_OPTS="-Xbootclasspath/a:/home/ec2-user/apache-tomcat/webapps/geoserver/WEB-INF/lib/marlin-0.7.3-Unsafe.jar -Dsun.java2d.renderer=org.marlin.pisces.PiscesRenderingEngine"
